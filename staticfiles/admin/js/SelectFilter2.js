...
'use strict';
{
   window.SelectFilter = {
       ...
       filter_key_down: function(event, field_id, source, target) {
           ...
           if (this.handleDirectionalMove(key, source, field_id, source_box, target)) {
               return;
           }
           
           this.handleVerticalMove(key, source_box);
       },

       handleDirectionalMove: function(key, source, field_id, source_box, target) {
       ...
       handleVerticalMove: function(key, source_box) {
           if (key === 40) {
